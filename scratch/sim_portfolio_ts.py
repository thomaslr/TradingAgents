...
for idx, date in enumerate(unique_dates):
    ...
    bench_history.append((date, bench_value))
    strat_history.append((date, strat_value))

print(f"Final TypeScript-equivalent Benchmark ROI: {bench_value-100.0:.2f}%")
print(f"Final TypeScript-equivalent Strategy ROI: {strat_value-100.0:.2f}%")
