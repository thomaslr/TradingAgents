...
for config in configs:
    ...
    for idx, date in enumerate(dataset_dates):
        ...
        if run:
            ...
            # Strategy D2 (Buy/Overweight = 1.0, Underweight = 0.5, Sell = 0.0)
            if 'buy' in rating or 'overweight' in rating:
                weight_d = 1.0
            elif 'underweight' in rating:
                weight_d = 0.5
